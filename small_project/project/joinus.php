...
<body id="page-top">
    ...
    <div class="modal fade" id="mymodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
           <form action="joinus.php" method="POST" method="POST">
    ...
    <section id="joinus">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5" style="background-color:#f05f40">
                    <div class="container">
                ...
                <div class="col-lg-5  text-center" >
                    <form action="join_process.php" method="POST">
                        <table class="table table-hover">
                            <thead>
                                <td align="center">
                                    <h4><strong>若您有意願加入本公司，請於下列欄位填寫資料，<font color="#f05f40">"橘色項目"</font> 請務必填寫，我們將會盡速與您聯絡!!</strong></h4></td>
                            </thead>
                            <tr>
                                <td align="center">
                                    <h4><strong><font color="#f05f40">您的姓名 </font></strong><input type="text" name="name" /></h4>
                                </td>    
                            </tr>
                            <tr>
                                <td align="center">
                            ...
                            <tr>
                                <td align="center">
                                    <h4><strong><font color="#f05f40">連絡電話 </font></strong><input type="text" name="cellphone" /></h4>
                                </td>
                            </tr>
